...
const adminChildren: RouteRecordRaw[] = [
  ...
  { path: 'avatar-decorations', name: 'admin-avatar-decorations', meta: { permissions: ['manage_subscription_plans'] }, component: () => import('@/pages/admin/AdminAvatarDecorationsPage.vue') },
