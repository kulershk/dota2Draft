  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'fantasy', name: 'admin-fantasy', meta: { permissions: ['manage_competitions', 'manage_own_competitions', 'manage_fantasy'] }, component: () => import('@/pages/admin/AdminFantasyPage.vue') },
